...
SECRET_KEY = 'django-insecure-%ie=dxw^ct*f*m73!tak(ta@fv5mg7gks)-(u#oa%%@tfzaxo3'
...
# Para usar SimpleJWT para los Tokens
...
DATABASES = {
    'default': {
        ...
        'USER': 'guazrthytmxqvs',
        'PORT': '5432',
        'PASSWORD': 'af6769874d1d1900f9b6aa7d3cc8752842f2a61b9d4838cfd329dbb057787edb',
    }
}
